...
import { sendAuctionLaunchEmails } from "@/lib/sendAuctionLaunchEmails"
...
export async function createAuction(formData) {
 ...
 const response = await sendAuctionLaunchEmails(data);
 if(response){
   return { success: true, auction: newAuction,message:"sending email" }
 }else{
