      ...
      <div className="max-w-7xl mx-auto z-10 relative">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.map((service, index) => (
            ...
            >
              <div className="relative h-full backdrop-blur-sm bg-white/20 rounded-xl  shadow-md hover:shadow-lg transition-all duration-300 border border-gray-400 group">
                ...
                {/* Popular badge */}
                {service.popular && (
                  <div className="absolute -top-3 left-4 bg-red-500 text-white text-xs font-medium py-1 px-3 rounded-full shadow-md z-10 flex items-center">
